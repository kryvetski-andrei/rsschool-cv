    ...
    <Frame title="projects">
      ...
      >
        <div
          ...
          style={{
            backgroundImage: `url(${
              process.env.PUBLIC_URL + "images/react-posts.png"
            })`,
          }}
        ></div>
        <div
          ...
          style={{
            backgroundImage: `url(${
              process.env.PUBLIC_URL + "images/museum.png"
            })`,
          }}
        ></div>
        <div
          ...
          style={{
            backgroundImage: `url(${
              process.env.PUBLIC_URL + "images/online-zoo.png"
            })`,
          }}
        ></div>
      </div>
          ...
          <ul className="projects__list">
            {filteredProjects.map((project) => (
              <li
                ...
                style={{
                  backgroundImage: `url(${
                    process.env.PUBLIC_URL + `images/${project.name}.png`
                  })`,
                }}
                key={project.id}
              >
